...
export default function ResumePreview() {
  ...
  const renderTemplate = () => {
    ...
    if (!templateId || templateId === "" || templateId === "undefined") {
      ...
      console.log("[v0] Auto-detected template:", effectiveTemplateId, "for profession in resume data")
    }

    // Handle job-specific templates based on template ID patterns
    if (effectiveTemplateId.startsWith("d")) {
      // Driver templates (d1, d2, d3)
      ...
      // Delivery Partner templates (dp1, dp2, dp3)
      ...
      // Mechanic templates (m1, m2, m3)
      const variant = effectiveTemplateId.substring(1)
      return <MechanicTemplate variant={variant} data={resumeData} />
    } else {
      // Legacy template handling for backwards compatibility
    ...
    <div className="container mx-auto py-8 px-6">
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold">
          Your{" "}
          {resumeData
            ? templateNames[detectProfessionFromData(resumeData)] || templateNames[templateId] || "Professional"
            : "Professional"}{" "}
          Resume
        </h1>
        <p className="text-gray-600 mt-2">Generated from your audio input</p>
